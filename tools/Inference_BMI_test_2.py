...
def main():
    ...
    for i in tqdm(range(len(file_name))) :
        one_image=os.path.join(image_path, file_name[i])
        one_name = file_name[i]
    ...
    predict_df.to_excel('/home/ylab3/HRnet_BMI_estimator/9_channel/HRnet_48_140_GT_Predict_paper.xlsx')
